...
#    Updated: 2022/02/12 21:41:23 by bmaaqoul         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS1 = swap_a.c swap_b.c ss.c rotate_a.c rotate_b.c rr.c rev_rotate_a.c \
		...
		ft_strlen.c ft_substr.c get_big.c get_pos.c get_small.c list_to_tab.c \
...
SRCS2 = swap_a.c swap_b.c ss.c rotate_a.c rotate_b.c rr.c rev_rotate_a.c \
		...
		ft_lstadd_front.c ft_lstlast.c checker.c 
